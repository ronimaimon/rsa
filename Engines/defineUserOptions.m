...
userOptions.analysisName = 'LetterPosition';

% This is the root directory of the project.
userOptions.rootPath = '/home/user/data/LetterPosition/FSL_analyzed/';

userOptions.monitor = true;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	userOptions.maskPath = ...
        [userOptions.rootPath filesep '[[subjectName]]' filesep 'masks' filesep '[[maskName]].nii.gz'];%'/imaging/mb01/lexpro/multivariate/ffx_simple/[[subjectName]]/[[maskName]].img';
...
%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	%% %% %% %% %%
		...
		userOptions.structuralsPath = [userOptions.rootPath filesep '[[subjectName]]' filesep 'anatomy' filesep];% e.g. /imaging/mb01/lexpro/[[subjectName]]/structurals/
	
		% What are the dimensions (in mm) of the voxels in the scans?
		userOptions.voxelSize = [1.71875 1.71875 3.5];
	
		% What radius of searchlight should be used (mm)?
		userOptions.searchlightRadius = 20;
...
userOptions.conditionLabels = userOptions.alternativeConditionLabels;
% What colours should be given to the conditions?
userOptions.conditionColours = [repmat([1 0 0], 4,1); repmat([0 0 1], 4,1)];
