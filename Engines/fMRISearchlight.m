function [varargout] = fMRISearchlight(fullBrainVols, binaryMasks_nS, models, userOptions)
%
...
if overwriteFlag
	...
	for subjectNumber = 1:nSubjects % and for each subject...
		...
		searchlightOptions.nSessions = 8;
		searchlightOptions.nConditions = 4;

% R		readFile = replaceWildcards(userOptions.betaPath, '[[subjectName]]', subject, '[[betaIdentifier]]', betas(1,1).identifier);
% R		subjectMetadataStruct = spm_vol(readFile);
